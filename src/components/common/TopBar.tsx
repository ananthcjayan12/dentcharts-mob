      ...
      {isMenuOpen && !onMenuClick && (
        <Portal>
          ...
          >
            {canAccessFinancials && (
              <div
                onClick={() => { navigate('/financial-dashboard'); setIsMenuOpen(false); }}
                className="px-4 py-3 hover:bg-gray-50/50 cursor-pointer flex items-center gap-3 border-b border-gray-100/50 transition-colors"
                data-testid="global-menu-financials"
              >
            ...
            {canAccessWhatsApp && (
              <div
                onClick={() => { navigate('/whatsapp-manager'); setIsMenuOpen(false); }}
                className="px-4 py-3 hover:bg-gray-50/50 cursor-pointer flex items-center gap-3 border-b border-gray-100/50 transition-colors"
                data-testid="global-menu-whatsapp"
              >
            ...
            {canAccessSettings && (
              <>
                <div
                  ...
                  className="px-4 py-3 hover:bg-gray-50/50 cursor-pointer flex items-center gap-3 transition-colors"
            ...
            <div
              ...
              className="px-4 py-3 hover:bg-red-50/50 cursor-pointer flex items-center gap-3 border-t border-gray-100/50 transition-colors"
              data-testid="global-menu-logout"
            >
